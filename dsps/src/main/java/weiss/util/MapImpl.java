...
{
    private Set<Entry<KeyType,ValueType>> theSet;
    
    protected abstract Entry<KeyType,ValueType> makePair( KeyType key, ValueType value );
    protected abstract Set<KeyType> makeEmptyKeySet( );
    protected abstract Set<Entry<KeyType,ValueType>> clonePairSet(Set<Entry<KeyType,ValueType>> pairSet );
    
    private Entry<KeyType,ValueType> makePair( KeyType key )
    {
        return makePair( (KeyType) key, null );
    }
        
    protected MapImpl( Set<Entry<KeyType,ValueType>> s )
    {
        theSet = s;
    }
    ...
    {
        Entry<KeyType,ValueType> match = theSet.getMatch( makePair( key ) );
    ...
    {
        private Iterator<Entry<KeyType,ValueType>> itr = theSet.iterator( );
     ...
     */
    protected Set<Entry<KeyType,ValueType>> getSet( )
    {
        return theSet;
    }
    
    protected abstract static class Pair<KeyType,ValueType> implements Entry<KeyType,ValueType>
    {
    ...
    public String toString( )
    {
        ...
        for( Entry<KeyType,ValueType> e : entrySet( ) )
            result.append( e + ", " );
